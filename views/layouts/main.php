...
<body class="h-full bg-gray-50">
    ...
    <div class="min-h-full flex flex-col">
        <div class="min-h-full flex flex-col">
            <!-- Header Principal -->
            <header
                class="bg-gradient-to-r from-yellow-600 via-yellow-500 to-amber-500 shadow-lg border-b border-yellow-600/30">
                    ...
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="hidden sm:flex items-center space-x-2 ml-8">
                                ...
                                <select
                                    class="text-sm text-gray-700 bg-white/60 border border-gray-300/50 rounded-md px-3 py-1 focus:ring-2 focus:ring-yellow-400 focus:border-transparent backdrop-blur-sm">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="hidden md:block relative">
                                ...
                                <input type="text"
                                    class="block w-64 xl:w-80 pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white/80 backdrop-blur-sm placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-yellow-400 focus:border-transparent sm:text-sm"
                                    placeholder="Buscar...">
                            </div>

                            <!-- Botón de búsqueda móvil -->
                            <button
                                class="md:hidden p-2 text-gray-600 hover:text-gray-800 hover:bg-white/40 rounded-md transition-colors">
                            ...
                            <div class="relative" id="profile-dropdown">
                                <button
                                    class="bg-gradient-to-r from-blue-500 to-purple-500 rounded-full p-2 text-white hover:from-blue-600 hover:to-purple-600 focus:outline-none focus:ring-2 focus:ring-blue-300"
                                ...
                                <div id="dropdown-menu-profile"
                                    class="hidden absolute right-0 mt-2 w-48 bg-white shadow-lg border border-gray-200 rounded-md z-50">
                                    <div class="py-2">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex space-x-0 overflow-x-auto scrollbar-hide">
                        <!-- Dashboard --> <a href="<?= Url::to(['/site/index']) ?>"
                            class="<?= Yii::$app->controller->id === 'site' && Yii::$app->controller->action->id === 'index' ? 'text-blue-600 bg-blue-50/50' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' ?> whitespace-nowrap inline-flex items-center px-4 py-4 text-sm font-medium transition-all duration-200 relative z-10">
                        ...
                        <div class="relative" id="ventas-dropdown">
                            <button type="button" id="ventas-button" aria-expanded="false" aria-haspopup="true"
            ...
            whitespace-nowrap inline-flex items-center px-4 py-4 text-sm font-medium transition-all duration-200 relative z-10">
                                ...
                                <svg id="dropdown-arrow-ventas" class="w-3 h-3 ml-1.5 transition-transform duration-200"
                            ...
                            <div id="dropdown-menu-ventas"
                                class="hidden absolute left-0 mt-1 w-48 bg-white shadow-lg border border-gray-200 rounded-md z-50">
                                <div class="py-2">
                                    <a href="<?= Url::to(['/ventas/index']) ?>" class="<?= Yii::$app->controller->id === 'ventas' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duration-150 no-underline">
                                        Ventas
                                    </a>
                                    <a href="<?= Url::to(['/ventas/dashboard']) ?>" class="<?= Yii::$app->controller->id === 'pedidos' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duration-150 no-underline">
                                        Dashboard
                                    </a>
                                </div>
                        ...
                        <a href="<?= Url::to(['/diseno/index']) ?>"
                            class="<?= Yii::$app->controller->id === 'diseno' ? 'text-blue-600 bg-blue-50/50' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' ?> whitespace-nowrap inline-flex items-center px-4 py-4 text-sm font-medium transition-all duration-200 relative z-10">
                            <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                stroke-width="2">
                                ...
                                <path
                                    d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.504 5.555-5.555C19.992 5.149 16.86 2 12 2Z" />
                            </svg> Diseño </a>


                        <!-- Producción con dropdown --->
                        <div class="relative" id="produccion-dropdown">
                            <button type="button" id="produccion-button" aria-expanded="false" aria-haspopup="true"
            ...
            whitespace-nowrap inline-flex items-center px-4 py-4 text-sm font-medium transition-all duration-200 relative z-10">
                                <svg class="w-4 h-4 mr-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 8 19.09a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09c.7 0 1.33-.4 1.62-1.02A1.65 1.65 0 0 0 5.04 8l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06c.46.46 1.12.6 1.71.37.62-.29 1.02-.92 1.02-1.62V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09c0 .7.4 1.33 1.02 1.62.59.23 1.25.09 1.71-.37l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06c-.46.46-.6 1.12-.37 1.71.29.62.92 1.02 1.62 1.02H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1Z" />
                                </svg>
                                Producción
                                <svg id="dropdown-arrow" class="w-3 h-3 ml-1.5 transition-transform duration-200"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            </button>
                            ...
                            <div id="dropdown-menu"
                                class="hidden absolute left-0 mt-1 w-48 bg-white shadow-lg border border-gray-200 rounded-md z-50">
                                <div class="py-2">
                                    <a href="<?= Url::to(['/produccion/index']) ?>" class="<?= Yii::$app->controller->id === 'produccion' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duration-150 no-underline">
                                        General
                                    </a>
                                    <a href="<?= Url::to(['/produccion/impresion']) ?>" class="<?= Yii::$app->controller->id === 'impresion' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transición-colors duración-150 no-underline">
                                        Impresión
                                    </a>
                                    <a href="<?= Url::to(['/produccion/corte']) ?>" class="<?= Yii::$app->controller->id === 'corte' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duración-150 no-underline">
                                        Corte
                                    </a>
                                    <a href="<?= Url::to(['/produccion/fabricacion']) ?>" class="<?= Yii::$app->controller->id === 'fabricacion' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duración-150 no-underline">
                                        Fabricación
                                    </a>
                                </div>
                        ...
                        <div class="relative" id="logistica-dropdown">
                            <button type="button" id="logistica-button" aria-expanded="false" aria-haspopup="true"
            ...
            whitespace-nowrap inline-flex items-center px-4 py-4 text-sm font-medium transition-all duration-200 relative z-10">
                                ...
                                Logística
                                <svg id="dropdown-arrow-logistica"
                                    class="w-3 h-3 ml-1.5 transition-transform duration-200" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                            ...
                            <div id="dropdown-menu-logistica"
                                class="hidden absolute left-0 mt-1 w-48 bg-white shadow-lg border border-gray-200 rounded-md z-50">
                                <div class="py-2">
                                    <a href="<?= Url::to(['/logistica/index']) ?>" class="<?= Yii::$app->controller->id === 'logistica' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duración-150 no-underline">
                                        General
                                    </a>
                                    <a href="<?= Url::to(['/logistica/atencion-clientes']) ?>" class="<?= Yii::$app->controller->id === 'envios' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duration-150 no-underline">
                                        Atencion a clientes
                                    </a>
                                </div>
                        ...
                        <!-- Administración con dropdown -->
                            <div class="relative" id="admin-dropdown">
                                <button type="button" id="admin-button" aria-expanded="false" aria-haspopup="true"
                                    class="<?= $adminActive
                                        ? 'text-blue-600 bg-blue-50/50'
                                        : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50' ?> 
            whitespace-nowrap inline-flex items-center px-4 py-4 text-sm font-medium transition-all duration-200 relative z-10">
                                    ...
                                    Administración
                                    <svg id="dropdown-arrow-admin" class="w-3 h-3 ml-1.5 transition-transform duration-200"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                ...
                                <div id="dropdown-menu-admin"
                                    class="hidden absolute left-0 mt-1 w-56 bg-white shadow-lg border border-gray-200 rounded-md z-50">
                                    <div class="py-2">
                                        <a href="<?= Url::to(['/admin/index']) ?>" class="<?= Yii::$app->controller->id === 'admin' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duration-150 no-underline">
                                            Panel
                                        </a>
                                        <a href="<?= Url::to(['/usuario/index']) ?>" class="<?= Yii::$app->controller->id === 'usuario' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duration-150 no-underline">
                                            Usuarios
                                        </a>
                                        <a href="<?= Url::to(['/role/index']) ?>" class="<?= Yii::$app->controller->id === 'role' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duración-150 no-underline">
                                            Roles
                                        </a>
                                        <a href="<?= Url::to(['/permiso/index']) ?>" class="<?= Yii::$app->controller->id === 'permiso' ? 'bg-blue-50 text-blue-600 font-semibold' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' ?> 
                      block px-4 py-2 text-sm transition-colors duración-150 no-underline">
                                            Permisos
                                        </a>
                                    </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                setupDropdown("notifs-button", "dropdown-menu-notifs", "dropdown-arrow-notifs");
            });
        </script>
