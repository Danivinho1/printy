        ...
        <?php foreach ($dataProvider->getModels() as $model): ?>
            <div class="item-bar">
                <div class="bar-content">
                    ...
                    <!-- Enlace Vector -->
                    <?php if (!empty($model->enlace_vector)): ?>
                        <div class="enlace-vector" style="margin-top: 5px;">
                            <strong>Vector: </strong> 
                            <a href="<?= Html::encode($model->enlace_vector) ?>" target="_blank">
                                <?= Html::encode($model->enlace_vector) ?>
                            </a>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="estado-toggle">
                        <?php $checked = $model->corte_listo == 1; ?>
