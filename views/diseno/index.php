...
<div class="filtros-diseño mb-4">
    <div class="d-flex align-items-center gap-2 mb-3">
        ...
        <!-- Botón Exportar -->
        <button type="button" class="btn-filtro ms-auto">
        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($model){
                    ...
                    $badge = Html::tag('span',$nombre,['class'=>'badge','style'=>"background-color:{$colores['bg']};color:{$colores['text']}"]);
                    return "<div class='editable-field estatus-badge' data-field-type='select' data-field-name='estatus_id' data-record-id='{$model->id}' data-current-value='{$model->estatus_id}' title='Click para editar'>{$badge}</div>";
                },
                'label'=>'Estatus'
            ],
...
$(".check-circle").on("click", function(){
    ...
    var statusCell = $(".editable-field.estatus-badge[data-record-id=\'" + id + "\']");
    ...
    $.ajax({
        url: "' . \yii\helpers\Url::to(["diseno/update-avance"]) . '",
        type: "POST",
        data: {
            id: parseInt(id),
            field: field,
