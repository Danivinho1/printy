...
{
    $searchModel = new \app\models\ProduccionSearch();

    // 🔹 Cargar parámetros de la request
    $params = Yii::$app->request->queryParams;

    // 🔹 Pasar al search (aquí se aplican los filtros)
    ...
    public function actionToggle()
{
    ...
    $allowedFields = ['diseno_impresion', 'corte_listo', 'fabricacion_listo', 'vector_listo'];
