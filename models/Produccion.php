...
class Produccion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['tipo_letrero_id', 'nombre_letrero', 'chapetones', 'diseno_impresion', 'corte_id', 'fabricacion_id', 'fecha_confirmacion', 'dias_restantes', 'estatus_pago_id', 'envio_id'], 'default', 'value' => null],
            [['unidades'], 'default', 'value' => 1],
            [['venta_id', 'diseno_id', 'disenador_id'], 'required'],
            [['venta_id', 'diseno_id', 'tipo_letrero_id', 'disenador_id', 'unidades', 'diseno_impresion', 'corte_id', 'fabricacion_id', 'dias_restantes', 'estatus_pago_id', 'envio_id'], 'integer'],
            ...
            [['envio_id'], 'exist', 'skipOnError' => true, 'targetClass' => Catalogos::class, 'targetAttribute' => ['envio_id' => 'id']],
        // ... tus otras reglas
    ...
    {
        return $this->hasOne(Catalogos::class, ['id' => 'envio_id']);
    }
