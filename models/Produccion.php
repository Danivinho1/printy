...
class Produccion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['tipo_letrero_id', 'nombre_letrero', 'chapetones', 'diseno_impresion', 'no_impresion', 'fecha_confirmacion', 'estatus_pago_id', 'empaquetado_id'], 'default', 'value' => null],
            ...
            [['fecha_confirmacion', 'created_at', 'updated_at', 'enlace_vector'], 'safe'],
            [['nombre_letrero', 'enlace_vector'], 'string', 'max' => 100],
