...
class Logistica extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['tipo_letrero_id', 'nombre_letrero', 'chapetones', 'telefono', 'estatus_pago_id', 'estatus_envio_id',], 'default', 'value' => null],
            [['num_chapetones', 'total', 'anticipo', 'restante'], 'default', 'value' => 0],
            [['venta_id'], 'required'],
            [['venta_id', 'tipo_letrero_id', 'num_chapetones', 'estatus_pago_id', 'estatus_envio_id',], 'integer'],
